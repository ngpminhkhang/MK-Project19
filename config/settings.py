...
DEBUG = os.environ.get('DEBUG', 'False') == 'False'  # False cho production
...
# ==========================================
# INSTITUTIONAL DATABASE ARCHITECTURE (NEON POSTGRESQL)
# ==========================================
# Sử dụng dj_database_url để ép Django bú máu trực tiếp từ máy chủ Neon.tech

DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://neondb_owner:npg_k8QAvcIrX5NR@ep-muddy-salad-a1kqe07o-pooler.ap-southeast-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require',
        conn_max_age=600,
